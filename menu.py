...
def principal():
    ...
    st.title('CARTERA DE PROYECTOS MINEROS')
    st.write("")
    st.write("")
    ...
    col1.write("")
    col1.write("")
    col1.markdown("<div style='text-align: justify'>Bienvenidos en esta app donde se realizó un análisis de los datos de las carteras de construcción y exploración mina.</div>", unsafe_allow_html=True)
    col1.markdown("<div style='text-align: justify'>Si quieres conocer el Código de esta app escrito en Python y conectado a Power Bi puedes visitarlo en el siguiente enlace <a style='color:black; font-size:110% ;' href='https://github.com/CartagenaMinas/cartera_proyectos_mina' target='_blank'><i class='fa fa-rocket'></i>GitHub</a> </div>", unsafe_allow_html=True)
    ...
    image = Image.open('imagenes/constr.jpg')
    col2.write("")
    col2.image(image, caption='CARTERA DE PROYECTOS')
